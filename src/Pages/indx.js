  ...
  return (
    <div>
          ...
          <nav>
            <ul className="list-unstyled d-flex justify-content-center mb-0">
              <li className="mx-3">
                <Link
                  to="/"
                  className="text-white bg-dark border-0 text-decoration-none"
                >
                  Home
                </Link>
              </li>
      ...
      <section className="text-center py-5">
        <h2>About Us</h2>
        <p>
          We are a leading company in our industry, offering top-notch products
          and services. Our mission is to deliver quality and value to our
          customers.
        </p>
      </section>
